...
st.title("Analisis Pertumbuhan Ekonomi Indonesia")
...
st.markdown(
    ...
    suatu negara yang ditinjau dari bertambahnya produksi barang industri,
    berkembangnya infrastruktur, bertambahnya sekolah, serta bertambahnya produksi
    barang modal dan bertambahnya sektor jasa. Menurut Boediono (2012), pertumbuhan
    ekonomi diartikan sebagai proses kenaikan output per kapita dalam jangka panjang.
    ...
    angka 7 persen. Namun krisis keuangan yang melanda Asia pada akhir tahun 1990-an
    memberikan dampak negatif bagi pertumbuhan perekonomian negara-negara Asia,
    salah satunya Indonesia. Sebagai salah satu negara yang terkena dampak krisis
    keuangan tersebut, pertumbuhan ekonomi Indonesia yang dilihat dari Produk
    ...
    perbaikan dan angka PDB mencapai sekitar 6 persen per tahunnya, kecuali pada
    ...
    pertumbuhan ekonomi suatu negara, dengan asumsi tingkat suku bunga dianggap
    konstan atau tetap. Selanjutnya, Solow mengembangkan teori Harrod-Domar dengan
    mengasumsikan bahwa tingkat suku bunga dapat berubah atau tidak konstan.
    Perubahan tingkat suku bunga tersebut akan memengaruhi tabungan dan investasi
    ...
    berpendapat bahwa akumulasi modal merupakan faktor penting dalam menentukan
    pertumbuhan ekonomi, namun lebih menekankan pada peningkatan kualitas sumber
    daya manusia (skill) dan penggunaan teknologi melalui penelitian dan
